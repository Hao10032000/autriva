  ...
  function mainMap() {
    ...
    function locationData(
      ...
      return (
        ...
        '<div class="box-car-list hv-one style-1">' +
        '<div class="image-group relative">' +

        '<div class="top flex-two">' +
        '<ul class="d-flex gap-8">' +
        '<li class="flag-tag success">New</li>' +
        ...
        '<a class="icon"><i class="icon-carus-arrowsleftright"></i></a>' +
        '</li>' +
        '<li class="box-icon w-32">' +
        '<a class="icon"><i class="icon-carus-heart"></i></a>' +
        '</li>' +
        '</ul>' +

        '<div class="img-style">' +
        '<img src="' + locationImg + '" alt="image" />' +
        '</div>' +
        '</div>' +

        '<div class="content">' +
        '<div class="flex-two gap-20">' +
        '<div class="money fs-24 fw-7 lh-30 text-color-2">' +
        job_address +
        '</div>' +
        '<img class="logo-car" src="/assets/images/car-list/logo-car.webp" />' +
        '</div>' +
        ...
        '<i class="icon-carus-icon7"></i>' +
        '<span>' + locationTopCity + '</span>' +
        '</div>' +
        '<div class="icons flex-three">' +
        '<i class="icon-carus-icon12"></i>' +
        '<span>' + locationTopCity2 + '</span>' +
        '</div>' +
        '<div class="icons flex-three">' +
        '<i class="icon-carus-icon9"></i>' +
        '<span>' + locationTopCity3 + '</span>' +
        '</div>' +
        '</div>' +
        ...
        '</div>' +
        '</div>' +
        '<a href="' + locationURL + '" class="view-car">' +
        'View <i class="icon-carus-arright"></i>' +
        '</a>' +
        '</div>' +
        '</div>' +
        '</div>' +
    ...
    var locations = [
      [
        locationData(
          "assets/images/car-list/car29.webp",
      ...
      [
        locationData(
          "assets/images/car-list/car30.webp",
          "property-detail-v1.html",
          "Sedan",
          "2017 BMV X1 xDrive 20d xline",
          "72,491 kms",
      ...
      [
        locationData(
          "assets/images/car-list/car31.webp",
          "property-detail-v1.html",
          "Sedan",
          "2017 BMV X1 xDrive 20d xline",
          "72,491 kms",
      ...
      [
        locationData(
          "assets/images/car-list/car32.webp",
          "property-detail-v1.html",
          "Sedan",
          "2017 BMV X1 xDrive 20d xline",
          "72,491 kms",
      ...
      [
        locationData(
          "assets/images/car-list/car33.webp",
          "property-detail-v1.html",
          "Sedan",
          "2017 BMV X1 xDrive 20d xline",
          "72,491 kms",
      ...
      [
        locationData(
          "assets/images/car-list/car34.webp",
          "property-detail-v1.html",
          "Sedan",
          "2017 BMV X1 xDrive 20d xline",
          "72,491 kms",
